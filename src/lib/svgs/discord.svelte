...
<style lang="scss">
	...
	div {
		...
		:global(svg) {
			color: rgba(var(--Base), 255);
		}
		filter: drop-shadow(-1px -1px 0px rgb(var(--Red))) drop-shadow(1px 1px 0px rgb(var(--Yellow))) drop-shadow(-1px 1px 0px rgb(var(--Green)))
			drop-shadow(1px -1px 0px rgb(var(--Blue)));
	}
